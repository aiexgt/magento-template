<?php
namespace Vendor\ServiceIntegration\Model\Service;

use Vendor\ServiceIntegration\Api\RestClientInterface;
use Vendor\ServiceIntegration\Api\SoapClientInterface;
